...
Along that line, for a constant $c$, the plane $z=c$ intersects the surface $z=f(x,y)$ at $f(x,y)=c$. Such an intersection is called the "trace\index{trace} of graph of $f$" in the plane $z=c$. And further, the level curve\index{Level curve} of $f$ at $c$ is the set of all points $(x,y)$ in the $xy$-plane which satisfy $f(x,y)=c$.
...
![Figure 2: Open set in 2 dimensions,](img/openset2d.png)
...
![Figure 4: Discontinuity,](img/discont.png)
...
![Figure 5: More discontinuity.](img/para.png)
