...
Brouwer's theorem stated formally:^[The applications of this theorem are divine. Suppose you take a sheet of paper, what are the ways in which this sheet can be mapped to itself?]

**Theorem.** Any continuous map $f:D^n\to D^n$ has at least one fixed point.
